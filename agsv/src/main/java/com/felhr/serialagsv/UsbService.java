...
buffer = stringTobytes("0008120C011039190000000000");
...
//              //  buffer[0] = ((byte) i);
              //  data = new String(buffer, "UTF-8");
                ...
                data1 = new String(buffer);

//                try {
//                    data1 = new String(buffer, "UTF-8");
//                } catch (UnsupportedEncodingException e) {
//                    e.printStackTrace();
//                }
                //data = new String(buffer, "UTF-8");
//                buffer = data.getBytes();
//                data= String.valueOf (buffer[0]+buffer[1]);


                if (mHandler != null)
                    mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT, data1).sendToTarget();

                Log.i("TAG", "Номер цикла: " + i);
